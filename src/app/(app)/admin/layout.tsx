...
import { LayoutDashboard, Tag, HelpCircle, Settings2, ClipboardList } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/attempts", label: "Respostas", icon: <ClipboardList className="size-4 shrink-0" /> },
