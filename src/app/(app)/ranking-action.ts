...
export async function fetchRankingAction(periodo: string, funcao?: string): Promise<RankingEntry[]> {
  ...
  return buildRanking((data ?? []) as unknown as Parameters<typeof buildRanking>[0], funcao);
}
